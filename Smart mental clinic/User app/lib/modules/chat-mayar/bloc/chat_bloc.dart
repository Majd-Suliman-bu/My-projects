...
import 'package:smart_medical_clinic/modules/chat-mayar/bloc/chat_functions.dart';
import 'package:smart_medical_clinic/modules/chat-mayar/bloc/chat_state.dart';
import 'package:smart_medical_clinic/modules/chat-mayar/helper-stuff/chat_card_model.dart';
...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  Future<int?> getMyIdFromPrefs() async {
    ...
    try {
      ...
      debugPrint('Error when getting the user id: $e');
      return null;
    }
    return userID2;
  }
